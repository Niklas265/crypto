/*
  ...
  /usr/bin/gengetopt --include-getopt --unamed-opts -i polybius-getopt.ggo -F polybius-getopt 
...
const char *gengetopt_args_info_purpose = "Command line options for the polybius executable\n\nBy Prof. Dr. Christoph Karg <christoph.karg@hs-aalen.de>";

const char *gengetopt_args_info_usage = "Usage: polybius [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --table       Dump key table",
  "  -r, --randomkey   Generate a random key",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->table_help = gengetopt_args_info_help[7] ;
  args_info->randomkey_help = gengetopt_args_info_help[8] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->randomkey_given)
    write_into_file(outfile, "randomkey", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVk:o:edtr", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* Dump key table.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->table_given),
              &(local_args_info.table_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "table", 't',
              additional_error))
            goto failure;
        ...
        case 'r':	/* Generate a random key.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->randomkey_given),
              &(local_args_info.randomkey_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "randomkey", 'r',
              additional_error))
            goto failure;
